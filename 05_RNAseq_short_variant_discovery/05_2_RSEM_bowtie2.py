#!/usr/bin/env python3
"""
05_2_RSEM_bowtie2.py: RSEM - align reads with Bowtie2
"""
import argparse
import os
import sys
...
class PipelineManager(PipelineManagerBase):
    ...
    def run_bowtie2(self, dependency_id=None):
        ...
        return self.submit_job("Bowtie2", dependency_id=dependency_id)
