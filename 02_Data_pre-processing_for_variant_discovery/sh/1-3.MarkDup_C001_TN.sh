...
#SBATCH --job-name='1-3.MarkDup_C001_TN'
#SBATCH --mem=55G
#SBATCH --export=ALL
/BiO/Share/Tools/gatk-4.6.1.0/gatk MarkDuplicatesSpark --input /BiO/Teach/Standard-Pipeline/02_Data_pre-processing_for_variant_discovery/C001_TN.Sort.bam --output /BiO/Teach/Standard-Pipeline/02_Data_pre-processing_for_variant_discovery/C001_TN.Sort.MarkDuplicates.bam --reference /BiO/Share/Tools/gatk-bundle/hg38/Homo_sapiens_assembly38.fasta --metrics-file /BiO/Teach/Standard-Pipeline/02_Data_pre-processing_for_variant_discovery/C001_TN.Sort.MarkDuplicates.metrics --duplicate-tagging-policy 'OpticalOnly' --tmp-dir /BiO/Temp -- --spark-master 'local[30]' --spark-verbosity 'INFO'